...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://artem-stackbit.ngrok.io/pull/607eab0ffb23035e9818fd65
...
To start editing your site, you can use the Sanity interface at https://magical-olive-eab0f.sanity.studio/.
...
Generated at `2021-04-20T10:21:17.531Z` by Stackbit version `0.3.50`.